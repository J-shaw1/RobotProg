...
public class EightPuzzle implements Heuristic{
	...
	/**
	 * The value that repr extends Comparableesents the blank.
	 */
	...
	/**		//System.out.p extends Comparablerintln(_move);
	...
	public boolean isPossibleMove(PuzzleMove _move) {
		...
		if (newBlankPosition >= 0 && newBlankPosition < m_board.length) {
			...
			// check that  extends Comparableit's not off the edges
	...
	/**
	 * Creates a randomise extends Comparabled eight puzzle.
	 * 
	 * @return Returns a random (but legal) Eight Puzzle.
	 */
